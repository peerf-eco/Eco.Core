 ...
 *
 * <description>
 *   Implementation of the hand-written `.etl` writer for `IEcoTestC1`.
 * </description>
 *
 * <author>
 ...
 *
 * <summary>
 *   SaveTypeLib_IEcoTestC1
 * </summary>
 *
 * <description>
 *   Build the directory describing `IEcoTestC1`
 *   and persist it as the corresponding `.etl` file.
 * </description>
 *
 */
void SaveTypeLib_IEcoTestC1(IEcoTypeLib1* pTypeLib) {
    ...
    pBuilder->pVTbl->CreateInterfaceDirectoryEntry(pBuilder, "IEcoTestC1", "Eco.Test.C1", &IID_IEcoTestC1, pDesc, &pEntry);
    ...
    filePath = UGUIDPtrToTypeLibFilePath(&IID_IEcoTestC1);
