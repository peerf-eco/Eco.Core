...
#define ECO_OPEN_MODE_MEMORY 0
#define ECO_OPEN_MODE_READ_FILE 0x01
#define ECO_OPEN_MODE_WRITE_FILE 0x02
...
typedef struct IEcoTypeLib1FileVTbl {
    ...
    int16_t (ECOCALLMETHOD *Open)(/* in */ IEcoTypeLib1FilePtr_t me, /* in */ const char_t* path, /* in */ uint32_t mode); 
    ...
    int16_t (ECOCALLMETHOD *ReadString)(/* in */ IEcoTypeLib1FilePtr_t me, /* in */ uint32_t offset, /* out */ uint32_t* pSize, /* out */ char_t** ppBuffer);
    ...
    /* Специализированная запись строки (с учетом нуль-терминатора) */
    int16_t (ECOCALLMETHOD *WriteString)(/* in */ IEcoTypeLib1FilePtr_t me, /* in */ uint32_t offset, /* out */ uint32_t* pSize, /* in */ char_t* buffer);
