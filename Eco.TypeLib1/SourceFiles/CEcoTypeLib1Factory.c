...
#include "CEcoTypeLib1Factory.h"

extern CEcoTypeLib1_01434A0B g_xCEcoTypeLib1_01434A0B;
 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoTypeLib1_01434A0BFactory_QueryInterface(IEcoComponentFactory* me, const UGUID* riid, void** ppv) {
 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoTypeLib1_01434A0BFactory_Init(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pIUnkSystem, /* in */ void* pv) {
    CEcoTypeLib1_01434A0BFactory* pCMe = (CEcoTypeLib1_01434A0BFactory*)me;
 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoTypeLib1_01434A0BFactory_Alloc(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pISystem, /* in */ struct IEcoUnknown *pIUnknownOuter, /* in */ const UGUID* riid, /* out */ void** ppv) {
    CEcoTypeLib1_01434A0BFactory* pCMe = (CEcoTypeLib1_01434A0BFactory*)me;
    IEcoUnknown* pIUnk = 0;
    int16_t result = ERR_ECO_POINTER;
    IEcoSystem1* pISys = 0;
    ...
    pCObj = (CEcoTypeLib1_01434A0B*)pIMem->pVTbl->Alloc(pIMem, sizeof(CEcoTypeLib1_01434A0B));
    if (pCObj == 0) {
        /* Freeing in case of an error */
        pIBus->pVTbl->Release(pIBus);
        pISys->pVTbl->Release(pISys);
    ...
    pCObj = (CEcoTypeLib1_01434A0B*)pIMem->pVTbl->Copy(pIMem, pCObj, &g_xCEcoTypeLib1_01434A0B, sizeof(CEcoTypeLib1_01434A0B));
...
IEcoComponentFactoryVTbl g_x8039E233E9A34D43BAF7833001434A0BFactoryVTbl = {
    CEcoTypeLib1_01434A0BFactory_QueryInterface,
    CEcoTypeLib1_01434A0BFactory_AddRef,
    CEcoTypeLib1_01434A0BFactory_Release,
    CEcoTypeLib1_01434A0BFactory_Alloc,
    CEcoTypeLib1_01434A0BFactory_Init,
    CEcoTypeLib1_01434A0BFactory_get_Name,
    CEcoTypeLib1_01434A0BFactory_get_Version,
    CEcoTypeLib1_01434A0BFactory_get_Manufacturer
};
 ...
 *
 */
CEcoTypeLib1_01434A0BFactory g_x8039E233E9A34D43BAF7833001434A0BFactory = {
    &g_x8039E233E9A34D43BAF7833001434A0BFactoryVTbl,
    0,
    "EcoTypeLib1\0",
    "1.0.0.0\0",
    "Peerf\0"
...
ECO_EXPORT IEcoComponentFactory* ECOCALLMETHOD GetIEcoComponentFactoryPtr() {
    return (IEcoComponentFactory*)&g_x8039E233E9A34D43BAF7833001434A0BFactory;
};
#elif ECO_LIB
IEcoComponentFactory* GetIEcoComponentFactoryPtr_8039E233E9A34D43BAF7833001434A0B = (IEcoComponentFactory*)&g_x8039E233E9A34D43BAF7833001434A0BFactory;
#endif
