...
xcopy /y build\libs\arm64-v8a\StaticDebug\libEco.System1UnitTest.so build\apk\lib\arm64-v8a\
xcopy /y build\libs\armeabi\StaticDebug\libEco.System1UnitTest.so build\apk\lib\armeabi\
xcopy /y build\libs\armeabi-v7a\StaticDebug\libEco.System1UnitTest.so build\apk\lib\armeabi-v7a\
xcopy /y build\libs\mips\StaticDebug\libEco.System1UnitTest.so build\apk\lib\mips\
xcopy /y build\libs\mips64\StaticDebug\libEco.System1UnitTest.so build\apk\lib\mips64\
xcopy /y build\libs\x86\StaticDebug\libEco.System1UnitTest.so build\apk\lib\x86\
xcopy /y build\libs\x86_64\StaticDebug\libEco.System1UnitTest.so build\apk\lib\x86_64\

set PROJECT=%~dp0
set TARGET=Eco.System1UnitTest
set SOURCE=ru\peerf\eco\system1unittest
