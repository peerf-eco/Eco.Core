...
#ifndef __I_ECO_SYSTEM_1_HPP__
#define __I_ECO_SYSTEM_1_HPP__
...
interface IEcoSystem1 : public IEcoUnknown {
public:
    /* IEcoSystem1 */
    virtual void ECOCALLMETHOD set_Data(/* in */ voidptr_t pv) = 0;
    virtual void* ECOCALLMETHOD get_Data(/* in */ void) = 0;

};

#endif /* __I_ECO_SYSTEM_1_HPP__ */
