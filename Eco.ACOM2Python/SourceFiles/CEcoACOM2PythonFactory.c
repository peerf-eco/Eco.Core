 ...
 *
 * <summary>
 *   CEcoACOM2Python_566F1CC3Factory
 * </summary>
 *
 * <description>
...
#include "CEcoACOM2PythonFactory.h"

extern CEcoACOM2Python_566F1CC3 g_xCEcoACOM2Python_566F1CC3;
 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoACOM2Python_566F1CC3Factory_Init(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pIUnkSystem, /* in */ void* pv) {
    CEcoACOM2Python_566F1CC3Factory* pCMe = (CEcoACOM2Python_566F1CC3Factory*)me;
 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoACOM2Python_566F1CC3Factory_Alloc(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pISystem, /* in */ struct IEcoUnknown *pIUnknownOuter, /* in */ const UGUID* riid, /* out */ void** ppv) {
    CEcoACOM2Python_566F1CC3Factory* pCMe = (CEcoACOM2Python_566F1CC3Factory*)me;
    IEcoUnknown* pIUnk = 0;
    int16_t result = ERR_ECO_POINTER;
    IEcoSystem1* pISys = 0;
    ...
    pCObj = (CEcoACOM2Python_566F1CC3*)pIMem->pVTbl->Alloc(pIMem, sizeof(CEcoACOM2Python_566F1CC3));
    if (pCObj == 0) {
        /* Freeing in case of an error */
        pIBus->pVTbl->Release(pIBus);
        pISys->pVTbl->Release(pISys);
    ...
    pCObj = (CEcoACOM2Python_566F1CC3*)pIMem->pVTbl->Copy(pIMem, pCObj, &g_xCEcoACOM2Python_566F1CC3, sizeof(CEcoACOM2Python_566F1CC3));
...
IEcoComponentFactoryVTbl g_x219EDB626EF14B42BE16F93A566F1CC3FactoryVTbl = {
    CEcoACOM2Python_566F1CC3Factory_QueryInterface,
    CEcoACOM2Python_566F1CC3Factory_AddRef,
    CEcoACOM2Python_566F1CC3Factory_Release,
    CEcoACOM2Python_566F1CC3Factory_Alloc,
    CEcoACOM2Python_566F1CC3Factory_Init,
    CEcoACOM2Python_566F1CC3Factory_get_Name,
    CEcoACOM2Python_566F1CC3Factory_get_Version,
    CEcoACOM2Python_566F1CC3Factory_get_Manufacturer
};
 ...
 *
 */
CEcoACOM2Python_566F1CC3Factory g_x219EDB626EF14B42BE16F93A566F1CC3Factory = {
    &g_x219EDB626EF14B42BE16F93A566F1CC3FactoryVTbl,
    0,
    "EcoACOM2Python\0",
    "1.0.0.0\0",
    "PeerF\0"
...
ECO_EXPORT IEcoComponentFactory* ECOCALLMETHOD GetIEcoComponentFactoryPtr() {
    return (IEcoComponentFactory*)&g_x219EDB626EF14B42BE16F93A566F1CC3Factory;
};
#elif ECO_LIB
IEcoComponentFactory* GetIEcoComponentFactoryPtr_219EDB626EF14B42BE16F93A566F1CC3 = (IEcoComponentFactory*)&g_x219EDB626EF14B42BE16F93A566F1CC3Factory;
#endif
